...
import { MegaMenu } from 'src/components/Snippets/Resource-Components/MegaMenuComponent';
import { ResourceCard, Resource } from 'src/components/Snippets/components/Resource-Components/ResourceCard';
          ...
          <Tabs defaultValue="all" className="w-full">
            ...
            {categories.slice(0, 8).map((category) => (
              <TabsContent key={category.id} value={category.slug} className="mt-6">
                ...
                {filteredResources.filter(resource => 
                  resource.categories.includes(category.slug)
                ).length === 0 &&import React, { useState, useEffect } from 'react';
import { SEO } from '@/components/SEO';
import { MegaMenu } from '@/components/Snippets/Resource-Components/MegaMenu-Component';
          ...
          <Tabs defaultValue="all" className="w-full">
            ...
            {categories.slice(0, 8).map((category) => (
              <TabsContent key={category.id} value={category.slug} className="mt-6">
                ...
                {filteredResources.filter(resource => 
                  resource.categories.includes(category.slug)
                ).length === 0 && <div className="text-center p-12">
